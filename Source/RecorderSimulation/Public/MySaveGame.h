...
private:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "SaveData", meta = (AllowPrivateAccess = "true"))
		TArray<TSoftObjectPtr<UTexture2D>> GatheredMemoList;
...
public:
	...
	virtual void AddGatheredMemo_Implementation(const TArray<TSoftObjectPtr<UTexture2D>>& NewMemoImages) override;
	virtual void SetInitGatheredMemo_Implementation() override;
	virtual TArray<TSoftObjectPtr<UTexture2D>> Req_GatheredMemo_Implementation() override;
